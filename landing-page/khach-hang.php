    ...
    <main>
        ...
        <section class="kh-hero container">
            <div class="kh-hero-left">
                <div class="hero-pill">
                    <i class="ph-fill ph-star"></i> ROSA AI Bridge
                </div>
        ...
        <section class="kh-section core-value container">
            ...
            <div class="value-grid">
                <div class="value-card">
                    ...
                    <p>Trả một lần cho máy chủ. Dùng bao nhiêu cũng được, không phát sinh.</p>
                </div>
                <div class="value-card">
                    <div class="value-icon value-blue"><i class="ph-fill ph-gauge"></i></div>
                    <h4>Không tường ngăn</h4>
                    <p>Chạy agent và tác vụ nặng cả ngày — không bao giờ bị block do quá tải.</p>
                </div>
                <div class="value-card">
                    <div class="value-icon value-teal"><i class="ph-fill ph-shield-check"></i></div>
                    <h4>Dữ liệu & bí mật công ty</h4>
                ...
                <div class="value-card">
                    ...
                    <p>Tương thích API OpenAI &amp; Anthropic — không cần viết lại một dòng code nào.</p>
                </div>
                <div class="value-card">
                    <div class="value-icon value-orange"><i class="ph-fill ph-code"></i></div>
                    <h4>Nền tảng cho lập trình viên</h4>
                    <p>API truy cập dễ dàng để hệ tự dùng tự viết script & triển khai máy nội bộ.</p>
                </div>
                <div class="value-card">
                    <div class="value-icon value-rose"><i class="ph-fill ph-cube"></i></div>
                    <h4>Năng lực AI trong một nốt</h4>
                    <p>Hỗ trợ text, ảnh, mô hình (Llama, Mistral, DeepSeek, Qwen,...) và nhiều hơn.</p>
                </div>
                <div class="value-card">
