        ...
        <form action="xuly-san-pham.php" method="POST" enctype="multipart/form-data" class="post-editor-grid">
            ...
            <div class="post-side">
                ...
                <div class="post-box">
                    ...
                    <input type="text" name="sku" placeholder="VD: AGI-AI238-1TB">

                    <label class="field-label">Loại sản phẩm</label>
                    <input type="text" name="loai_san_pham" placeholder="VD: SSD gắn ngoài">

                    <label class="field-label">Chuẩn kết nối</label>
                    <input type="text" name="chuan_ket_noi" placeholder="VD: USB 3.2 Gen 1">

                    <div class="field-row">
                        <div>
                            <label class="field-label">Tốc độ đọc</label>
                            <input type="text" name="toc_do_doc" placeholder="VD: Lên đến 520 MB/s">
                        </div>
                        <div>
                            <label class="field-label">Tốc độ ghi</label>
                            <input type="text" name="toc_do_ghi" placeholder="VD: Lên đến 500 MB/s">
                        </div>
                    </div>
                    ...
                    <div class="field-row">
                        <div>
                            ...
                            <input type="text" name="kich_thuoc" placeholder="VD: 110 x 41 x 9 mm">
                        </div>
                        <div>
                            <label class="field-label">Trọng lượng</label>
                            <input type="text" name="trong_luong" placeholder="VD: ~80g">
                        </div>
                    </div>

                    <label class="field-label">Bảo hành</label>
                    <input type="text" name="bao_hanh" placeholder="VD: 36 tháng chính hãng">
                </div>
