                ...
                <div class="post-box">
                    ...
                    <div class="field-row">
                        <div>
                            ...
                            <input type="number" name="gia_nhap" min="0" value="0" required>
                        </div>
                        <div>
                            <label class="field-label">Giá bán</label>
                            <input type="number" name="gia_ban" min="0" value="0" required>
                        </div>
                    </div>
                    <div class="field-row">
                        <div>
                            <label class="field-label">Giảm giá (%)</label>
                            <input type="number" name="giam_gia" min="0" max="100" value="0">
                        </div>
                        <div>
